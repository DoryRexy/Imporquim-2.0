  ...
  return (
    <div className="min-h-[44rem] flex flex-col justify-center items-center bg-ice_gris-200">
      <Image
        ...
        src="/img/utils/comingSoon.png"
        alt="Logo"
        className="object-cover w-40 h-40 mb-8 rounded-full"
      />
      <h1 className="text-4xl font-bold mb-4">Próximamente</h1>
      <p className="text-lg text-center max-w-lg mb-8 px-4 md:px-0">
        Estamos comprometidos con el mantenimiento continuo de este sito. Pronto
        tendrémos más actualizaciones!
      </p>
