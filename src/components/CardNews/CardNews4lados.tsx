...
export default function CardNews4lados(props: Props) {
  return (
    <div
      className={`bg-no-repeat bg-cover bg-center grid ${props.clases}`}
      style={{
    ...
    >
      <div className="h-[24rem]">
        <div className="grid w-full justify-end text-xs p-2 ">{props.date}</div>
        ...
        <div className="grid grid-cols-12 text-base justify-end  ">
          <div className="col-span-5"></div>
          <div className="col-span-7 text-xl mix-blend-normal">
            {props.children}
          </div>
        </div>
        ...
        <div className={`${props.clasesCuadro3} flex justify-end w-4/6 mt-12`}>
          <CustomButton
            title="Ver más >"
            classes="bg-ice_azul-950 text-xs"
            onClick={() => {
