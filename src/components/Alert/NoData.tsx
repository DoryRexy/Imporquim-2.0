...
export default function NoData({ title, paragraph }: Props) {
    return (
        <div className="bg-ice_verde-700 border-t-4 border-ice_verde-950 rounded-b text-white px-4 py-3 shadow-md my-4" role="alert">
            <div className="flex">
