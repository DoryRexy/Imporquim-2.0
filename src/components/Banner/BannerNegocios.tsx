...
export default function BannerNegocios({
  title,
  img,
  icon,
  classes,
  ...
  return (
    <div className={`${classes}   w-full grid grid-cols-12 lg:pt-8 xl:pt-24  `}>
      {/**IMAGENES DE FONDO **/}
      <div
        className="hidden col-span-12 sm:grid sm:grid-flow-col sm:col-span-1 
            xl:col-span-1 xl:grid-flow-row
            place-content-between opacity-40 "
      >
        <SvgLoader
          classes="w-56"
          src="/img/negocios/carIcon.svg"
          alt="Icono"
        ></SvgLoader>
      ...
      {/**TITULO **/}
      <div
        className={`${borderClasses}  grid col-span-12 sm:col-span-10 
            xl:col-span-4 
      ...
      >
        <div className=" grid gap-5 text-lg text-ice_azul-950 mx-2 px-4 my-3  lg:min-w-[20rem] xl:-translate-y-14 2xl:max-w-md   ">
          <h1 className="text-[2.4rem] lg:text-7xl font-bold text-ice_azul-950 text-center">
            {title}
          </h1>
          <div
            className="text-sm lg:text-base leading-5 justify-self-center xl:leading-5
      ...
      {/**IMAGEN PORTADA **/}
      <div
        className="grid  col-span-12 lg:col-span-9 sm:justify-center lg:justify-end
            xl:col-span-5
            content-end  "
      >
        <img
          className="sm:max-w-md xl:max-w-2xl "
          width={finalWidth}
          height={finalHeight}
          src="/img/negocios/portada.png"
          alt="Portada Negocios"
        ></img>
      </div>
      {/**ESENCIAL **/}
      <div className="hidden   place-content-center justify-center content-center lg:grid lg:col-span-3 xl:col-span-1 xl:content-start ">
        <SvgLoader
          classes="w-56"
          src="/img/bannerPrincipal/esencialCR.svg"
          alt="Icono"
        />
      </div>
    </div>
