...
const FlipCard = ({ title, img, children }: Props) => {
  ...
  return (
    <div
      className=" group flip-card w-[18rem] h-[20rem]  text-white "
      onMouseEnter={handleFlip}
      onMouseLeave={handleFlip}
    >
      <motion.div
        className="flip-card-inner w-[100%] h-[100%] shadow-md grid place-content-center "
        initial={false}
      ...
      >
        <div
          className={`flip-card-front w-[100%] h-[100%] grid place-content-center gap-4 bg-ice_azul-950 rounded-md font-bold `}
        >
        ...
        <div
          className={`flip-card-back w-[100%] h-[100%] bg-ice_gris-200 
