        ...
        col-span-10 md:col-span-6 "
          ...
          <div className="grid  col-span-9 md:col-span-6 ">
            ...
            <Carrousel autoSlider>
              <img src="img/Carruseles/Quimico2.png" alt="" />
              <img src="img/Carruseles/5.png" alt="" />
              <img src="img/Carruseles/4.png" alt="" />
              <img src="img/Carruseles/3.png" alt="" />
              <img src="img/Carruseles/2.png" alt="" />
              <img src="img/Carruseles/6.png" alt="" />
            </Carrousel>
          </div>
        </div>
      </div>
